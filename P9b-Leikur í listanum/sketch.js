...
//Tapar 2 ef ekki er hitt 2 í röð
...
function draw() {
  ...
  text("Tapar 2 ef ekki er hitt 2x í röð",550,50);
  text("Tapar 2 eftir: " + nidurtalning,10,70);
...
function mouseClicked(){
  ...
  if (hitti == 0) {
      nidurtalning = nidurtalning - 1;
  }else {
   nidurtalning = 2
  }
  //eyðir 2 Eggertum ef ekki er hitt 2 sinnum
  if(nidurtalning==0){
      eggertar.splice(eggertar.length-2,2);
      nidurtalning=2
  }
}
